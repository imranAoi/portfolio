...
import until4 from '../assets/images/until4.png'
 function Latest() {
  return (
    <div className='bg-[#111] p-2'>
       ...
       <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        <div className="order-2 sm:order-1 w-full">
          <h3 className="text-[#ffe578] font-bold text-2xl md:text-4xl">AI-Powered Ticket Management System</h3>
         
          <p className="text-justify text-sm md:text-base mt-2">
            AI-Powered Ticket Management System is a full-stack customer support platform that streamlines ticket handling for organizations. The system supports three user roles—Admin, Agent, and Customer—with secure authentication via JWT and Firebase OAuth (Google/GitHub). Key features include real-time ticket updates and task collaboration using Socket.IO, file uploads with Cloudinary, email notifications, custom form builder with Excel export, and an AI-powered insights dashboard. The frontend is built with Next.js and Tailwind CSS, achieving a 95+ Lighthouse score through dynamic metadata, lazy loading, and responsive design.
          </p>
        ...
        <a href="https://ai-powered-ticket.vercel.app/" className="order-1 sm:order-2 flex w-full relative justify-center sm:justify-start">
          <div className="flex flex-col items-center relative group sm:hover:scale-105 ease-in-out duration-200 sm:ml-auto">
            <img className="max-w-[400px] w-full relative z-10 drop-shadow-[0_0px_60px_rgba(59,130,246,0.6)]" src={until4} alt="" />
