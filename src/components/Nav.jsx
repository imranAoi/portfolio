...
function Nav() {
  ...
  const roles = ['MERN Developer', 'Fullstack Developer', 'DevOps Engineer'];
  ...
  return (
    ...
    <div className='flex -translate-y-2   mt-40'>
        
      <ul className='ml-auto lg:mr-8 mr-2 lg:mr-4 -translate-y-20 lg:space-y-5 space-y-4 text-[#b0b2c3]'>
        <li>
          <a
            href="https://www.linkedin.com/in/mohd-imran-08808b2b1/"
            target="_blank"
        ...
        <li>
           <a
            href="https://x.com/ImranAnsar38040"
            target="_blank"
            rel="noopener noreferrer"
          >
          <svg
        ...
        <li>
          <a
            href="https://www.instagram.com/_.imran._.ansari._?igsh=YzljYTk1ODg3Zg%3D%3D"
            target="_blank"
            rel="noopener noreferrer"
          >
          <svg
        ...
        <li>
          <a
            href="mailto:ansarimran987@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
          <svg
        ...
        <li>
            <a
            href="https://github.com/imranAoi"
            target="_blank"
            rel="noopener noreferrer"
          >
          <svg
      ...
      <div className="absolute lg:left-1/4 left-6 bottom-20 w-[80vw] max-w-[400px]">
  <img 
    src={imran} 
    alt='Imran' 
    className='w-full h-auto object-contain  translate-4 -translate-x-6'
  />
  <h2 className="lg:text-2xl text-xl font-semibold text-blue-500 mb-6 flex gap-2">
          I am
